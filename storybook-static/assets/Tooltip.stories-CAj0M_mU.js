 ...
 */const p=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]],l=c("Plus",p),y={title:"Components/Tooltip",component:n,argTypes:{btn:{control:!1,description:"Button component to be wrapped inside TooltipTrigger"},content:{control:!1,description:"Tooltip content (supports HTML/JSX)"},className:{control:"text",description:"CSS class for TooltipContent"}}},o={args:{btn:t.jsx(i,{variant:"secondary",startIcon:t.jsx(l,{}),endIcon:t.jsx(a,{}),children:"Add Item"}),content:t.jsxs("div",{className:"text-white p-2",children:[t.jsx("h1",{className:"text-lg font-bold",children:"Tooltip Title"}),t.jsxs("p",{className:"text-sm",children:["This is a tooltip with ",t.jsx("strong",{children:"HTML content"}),"."]})]}),className:"bg-amber-500 fill-amber-500"}};var e,s,r;o.parameters={...o.parameters,docs:{...(e=o.parameters)==null?void 0:e.docs,source:{originalSource:`{
  args: {
...
}`,...(r=(s=o.parameters)==null?void 0:s.docs)==null?void 0:r.source}}};const w=["IconButtonTooltip"];export{o as IconButtonTooltip,w as __namedExportsOrder,y as default};
