      ...
      {selectedRows.size > 0 && (
        <div className="delete absolute bottom-5 bg-white border shadow-md rounded-[8px] py-[5px] px-[17px] left-1/2 transform -translate-x-1/2 flex gap-3 items-center z-10">
          ...
          <Tooltip>
            <TooltipTrigger>
              <span
                className="bg-white shadow-lg border rounded-md h-5 w-5 p-0.5 flex items-center hover:bg-destructive-200 hover:text-destructive-500 hover:cursor-pointer"
