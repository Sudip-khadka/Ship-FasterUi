...
function CustomDropDown({
  ...
  const renderItem = (item: ItemType,itemClassName?:string) => {
    ...
    if (item.href) {
      return (
        <DropdownMenuItem key={item.id} disabled={item.disabled} className={cn(itemClassName,className)} onClick={item.onClick}  asChild>
