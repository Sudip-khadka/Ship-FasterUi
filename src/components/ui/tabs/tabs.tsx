...
export type TabsVariant = "dot" | "default" | "button" | "buttonOutlined" | "divider" | "lineTop" | "lineBottom"
export type TabsSize = "default" | "sm" | "md" | "lg"
...
function TabsLabel({ value, className,...props }: TabsLabelProps) {
  return (
    <div
      className={cn(
