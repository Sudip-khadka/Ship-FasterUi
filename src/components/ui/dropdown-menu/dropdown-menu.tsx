...
function DropdownMenuTrigger({
  ...
  return (
    <DropdownMenuPrimitive.Trigger
      ...
      className="hover:cursor-pointer focus-visible:border-none focus:border-none focus:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 w-fit"
      {...props}
    />
  )
}
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        checked ? "pl-8" : "pl-2", // Adjust padding based on `checked`
        className
      )}
      checked={checked}
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[inset]:pl-8 text-secondary-800",
        className
      )}
      {...props}
    >
