...
const badgeVariants = cva(
  "inline-flex items-center justify-center border px-3 py-1.5 text-md font-medium w-fit whitespace-nowrap shrink-0 gap-2 transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        primary:
