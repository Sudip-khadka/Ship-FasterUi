...
export const Customizable: StoryObj<StoryProps> = {
  ...
  render: ({ defaultOpen, collapsible, side,variant,showSearchBar }) => (
    <SidebarProvider defaultOpen={defaultOpen}>
       <SideBarContentWrapper logo={<IconLogo/>} title="Phoenix" collapsible={collapsible} side={side} variant={variant} groupItems={groupItems} otherContent={otherContent} showSearchBar={showSearchBar}/>
    </SidebarProvider>
  )
};
